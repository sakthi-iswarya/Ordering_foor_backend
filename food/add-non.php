...
if(isset($_POST['Submit']))
{
    ...
    $h_name=$_POST['h_name'];
    $non_veg_name=$_POST['non_veg_name'];
    $n_amount=$_POST['n_amount'];
    $date=$_POST['date'];

    $msg=mysqli_query($con,"insert into non_veg(user_name,user_email_id,h_name,non_veg_name,n_amount,date) 
          values('$user_name','$user_email_id','$h_name','$non_veg_name','$n_amount','$date')");
  ...
  <body>
    <section id="container" >
        <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Add Non-Veg Items</b></a>
                    ...
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="user_email_id" value="" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Non-Veg Item Name</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="non_veg_name" value="" >
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">non-Veg Item Amount</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="n_amount" value="" >
                                </div>
                            </div>


                            <div class="form-group">
                                <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Non-Veg Item Posting Date</label>
                                <div class="col-sm-10">
                            ...
                            <div style="margin-left:100px; padding-bottom:20px;" >
                                <input type="submit" name="Submit" value="Post Non-Veg Items" class="btn btn-theme" style="color:white;
