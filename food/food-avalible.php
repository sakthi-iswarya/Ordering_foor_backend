...
if(isset($_POST['Submit']))
{
    ...
    $msg=mysqli_query($con,"insert into food_avaliable(name,email,hotel_name,veg_nonveg,food_name,amount) 
          values('$name','$email','$hotel_name','$veg_nonveg','$food_name','$amount')");
...
<html lang="en">
  ...
  <body>
    ...
    <header class="header black-bg"  style="background-color:black;">
            ...
            <a href="dashboard.php" class="logo"><b>Food Avalible </b></a>
        ...
        <section id="main-content">
            <section class="wrapper">
                <h3><i class="fa fa-angle-right"></i>Food Avaliable</h3>
                <div class="row"> 
                    <div class="col-md-12">
                        <div class="content-panel">
                            ...
                            <div class="form-group">
                                ...
                                <select name='hotel_name'>  
                                    <option value="<?php echo $row_list['h_names'];?>">Hotel name</option> 
                                    <?php  
                                        $list=mysqli_query($con,"select * from hotels_name");  
                                    while($row_list=mysqli_fetch_assoc($list)){  
                                        ?>  
                                            <option value="<?php echo $row_list['h_names']; ?>"> 
                                             <?php echo $row_list['h_names'];?>  
                                            </option>  
                                        <?php  
                                        }  
                                        ?>
                            ...
                            <div style="margin-left:100px; padding-bottom:20px;" >
                                <input type="submit" name="Submit" value="Post Food Items" class="btn btn-theme" style="color:white;
